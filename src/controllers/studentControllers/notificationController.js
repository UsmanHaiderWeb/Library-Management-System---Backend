...
exports.markAllNotificationsAsReadController = exports.markNotificationAsReadController = exports.getNotificationsController = void 0;
...
const markNotificationAsReadController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const { id } = req.params;
        yield notification_service_1.NotificationService.markAsRead(id, user.id);
 ...
 */
const markAllNotificationsAsReadController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
