...
exports.allBorrowBooksController = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const express_1 = require("express");
const prismaDb_1 = require("../../helpers/prismaDb");
const dateUtils_1 = require("../../helpers/dateUtils");
const allBorrowBooksController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (dateCondition) {
            whereClause.borrowedOn = dateCondition;
        }
...
exports.allBorrowBooksController = allBorrowBooksController;
